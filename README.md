...
- [storesafe / android-sqlite-evplus-ext-native-driver-free](https://github.com/storesafe/android-sqlite-evplus-ext-native-driver-free) - with GPL v3 or commercial license options
...
- `evplus-native-driver.jar` - android-sqlite-evplus-ext-native-driver-free NDK JAR built with SQLite `3.35.4` amalgamation, with the following option flags:
